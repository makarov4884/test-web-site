                ...
                <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" onClick={() => setSelectedVideos(null)}>
                    <div className="relative w-full max-w-5xl bg-black rounded-xl overflow-hidden shadow-2xl flex flex-col items-center justify-center aspect-video" onClick={e => e.stopPropagation()}>
                        ...
                        {availableAuthors.length > 2 && (
                            <div className="absolute top-4 left-1/2 -translate-x-1/2 z-30 flex flex-wrap justify-center gap-2 max-w-[95%] p-2">
                                {availableAuthors.map(author => (
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-xs font-bold transition-transform hover:scale-105 ${activeAuthor === author
                                            ? 'bg-pink-600 text-white shadow-lg ring-2 ring-white/50'
                                            : 'bg-white/90 text-gray-800 hover:bg-white border border-gray-300 shadow-sm'
                                            }`}
                                    >
