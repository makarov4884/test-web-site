                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="aspect-video bg-gray-900 relative overflow-hidden">
                                        <img
                                            src={youtubeVideos.main?.thumbnail || 'https://via.placeholder.com/480x270/ef4444/ffffff?text=TEAM+JINU'}
                                            alt="TEAM JINU"
                                    ...
                                    <div className="bg-white p-4">
                                        <div className="flex items-start gap-3">
                                            <img
                                                src={youtubeVideos.main?.channelProfileImage || 'https://via.placeholder.com/40/ef4444/ffffff?text=팀'}
                                                alt="팀진우"
                                ...
                                >
                                    ...
                                    <div className="aspect-video bg-gray-900 relative overflow-hidden">
                                        <img
                                            src={youtubeVideos.sub?.thumbnail || 'https://via.placeholder.com/480x270/9333ea/ffffff?text=TEAM-JINU'}
                                            alt="TEAM-JINU"
                                            className="w-full h-full object-cover"
                                        />
                                        <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-all"></div>
                                    ...
                                    <div className="bg-white p-4">
                                        <div className="flex items-start gap-3">
                                            <img
                                                src={youtubeVideos.sub?.channelProfileImage || 'https://via.placeholder.com/40/9333ea/ffffff?text=박'}
                                                alt="박진우"
                                                className="w-10 h-10 rounded-full object-cover shrink-0"
                                            />
                                            <div className="flex-1 min-w-0">
