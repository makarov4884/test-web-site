        ...
        try {
            ...
            if (await statsBtn.count() > 0) {
                ...
                try {
                    ...
                    await page.waitForSelector('div[data-list="vipRankging_all"] > div:not(.animate-pulse)', { state: 'attached', timeout: 15000 });
                ...
                await page.waitForTimeout(5000); // Wait for animation/population and chart rendering
